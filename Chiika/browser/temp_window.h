...
#include "Chiika/browser/client_types.h"

#if defined(OS_WIN)
#include "Chiika/browser/temp_window_win.h"
#elif defined(OS_LINUX)
#include "Chiika/browser/temp_window_x11.h"
#elif defined(OS_MACOSX)
#include "Chiika/browser/temp_window_mac.h"
#endif
