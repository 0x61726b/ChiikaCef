...
#include "Chiika/browser/root_window_win.h"

#include "include/base/cef_bind.h"
#include "include/base/cef_build.h"
#include "include/cef_app.h"
#include "Chiika/browser/browser_window_osr_win.h"
#include "Chiika/browser/browser_window_std_win.h"
#include "Chiika/browser/geometry_util.h"
#include "Chiika/browser/main_context.h"
#include "Chiika/browser/main_message_loop.h"
#include "Chiika/browser/resource.h"
#include "Chiika/browser/temp_window.h"
#include "Chiika/browser/util_win.h"
#include "Chiika/browser/window_test.h"
...
namespace client {
	...
	void RootWindowWin::CreateRootWindow(const CefBrowserSettings& settings) {
		...
		const DWORD dwStyle = WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_THICKFRAME;
